...
export const sectionCommitmentsData = {
  commitments: [
    {
      title: "Respect des données personnelles",
      text: [
        <>
          <p>
    ...
    },
    {
      ...
      text: [
        <>
          <p>
            L’éco-conception se réfléchit à toutes les étapes d’un projet : créer un site sur-mesure pour
  ...
  steps: [
    {
      ...
      image_alt: "Une personne écrit sur un papier",
    },
    {
      title: "Préparation",
      text: [
      ...
      image_alt: "Une feuille de papier avec des wireframes",
    },
    {
      title: "Conception",
      text: [
      ...
      image: "/images/services/etape_3.webp",
      image_alt: "Des ordinateurs avec des sites web",
    },
    {
      title: "Maintenance",
      text: [
      ...
      image_alt: "Quelqu'un qui tape sur un clavier d'ordinateur",
    },
  ],
};
      ...
      answer: [
        <>
          ...
          <ul>
            ...
            <li>
              <strong>Un site e-commerce </strong>: à partir de 2000€
            </li>
            <li>
