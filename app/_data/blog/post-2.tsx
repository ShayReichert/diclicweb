        ...
        <>
          ...
          <ul>
            ...
            <li>
              ...
              mot. <br />
              Par exemple, "les étudiant(e)s" englobe toutes les personnes étudiantes, quel que soit leur genre.
            </li>
            <li>
              <strong>Utiliser des doublons : </strong>Permet d’inclure la forme masculine et féminine.
              <br />
              Par exemple, “les clientes et les clients peuvent commander en ligne”
            </li>
            <li>
            ...
            <li>
              ...
              approche permet d'inclure tous les genres dans une formulation collective.
              <br />
              Par exemple : "Les femmes, les hommes et les personnes non-binaires sont les bienvenu·es."
            </li>
            <li>
