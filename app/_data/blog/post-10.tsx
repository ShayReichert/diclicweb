      ...
      text: [
        <>
          <p>
            ...
            <strong> l'expérience des utilisateur·ices </strong>de votre site web.
            <br />
          </p>
          <p>
            {" "}
...

    {
      ...
      text: [
        <>
          ...
          <h3 className={rocaOne.className}>Amélioration de la navigation</h3>
          <p>
          ...
          <p>
            Une compression efficace des images<strong> réduit leur taille sans compromettre la qualité visuelle</strong>, assurant ainsi un affichage
            <strong> rapide et sans interruption</strong>. Cela contribue à une expérience utilisateur·ice fluide et satisfaisante, réduisant le
            risque de frustration et d'abandon de la part des visiteur·ices.
          </p>
        ...
        <>
          ...
          <ol>
            ...
            <li>
              ...
              Glissez-déposez simplement vos images sur la plateforme et cliquez sur "Download" pour récupérer vos images compressées.
              <br />
              <small>
                <em>
            ...
            <li>
              ...
              contenu. Cela facilite non seulement l'organisation, mais contribue également à améliorer le référencement.
            </li>
    ...
    },
    {
      ...
      text: [
        <>
          <p>-------</p>
          <p>
            L'optimisation des images est bien plus qu'une simple amélioration technique : en prenant le temps de compresser et d'optimiser chaque
            image, vous investissez dans<strong> la performance et la durabilité </strong>de votre site !
          </p>
          <p>
            {" "}
